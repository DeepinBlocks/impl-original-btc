#include "CSendingDialogBase.h"


CSendingDialogBase::CSendingDialogBase(wxWindow* parent,
                                       wxWindowID id,
                                       ...
                                       long style) : wxDialog(parent, id, title, pos, size, style)
{
    ...
    m_buttonOK->Connect(wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler(CSendingDialogBase::OnButtonOK), nullptr, this);
    m_buttonCancel->Connect(wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler(CSendingDialogBase::OnButtonCancel), nullptr, this);
}
...
CSendingDialogBase::~CSendingDialogBase()
{
    ...
    m_buttonOK->Disconnect(wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler(CSendingDialogBase::OnButtonOK), nullptr, this);
    m_buttonCancel->Disconnect(wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler(CSendingDialogBase::OnButtonCancel), nullptr, this);
}