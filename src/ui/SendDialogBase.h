#ifndef BITCOIN_SENDDIALOGBASE_H
#define BITCOIN_SENDDIALOGBASE_H

#include "common.h"

class SendDialogBase : public wxDialog {
public:
    SendDialogBase(wxWindow* parent, wxWindowID id = wxID_ANY, const wxString& title = wxT("Send Coins"), const wxPoint& pos = wxDefaultPosition, const wxSize& size = wxSize(675, 338), long style = wxDEFAULT_DIALOG_STYLE | wxRESIZE_BORDER);
    ~SendDialogBase();
protected:
...
#endif //BITCOIN_SENDDIALOGBASE_H
