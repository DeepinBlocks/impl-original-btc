...
AboutDialogBase::AboutDialogBase(wxWindow* parent,
                                 wxWindowID id,
                                 ...
                                 long style) : wxDialog(parent, id, title, pos, size, style)
{
    ...
    // Connect Events
    m_buttonOK->Connect(wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler(AboutDialogBase::OnButtonOK), nullptr, this);
}

AboutDialogBase::~AboutDialogBase()
{
    // Disconnect Events
    m_buttonOK->Disconnect(wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler(AboutDialogBase::OnButtonOK), nullptr, this);
}