#ifndef BITCOIN_EDITPRODUCTDIALOGBASE_H
#define BITCOIN_EDITPRODUCTDIALOGBASE_H
#include "common.h"

class EditProductDialogBase : public wxFrame {
public:
    wxFlexGridSizer* fgSizer5;
    EditProductDialogBase(wxWindow* parent, wxWindowID id = wxID_ANY, const wxString& title = wxT("Edit Product"), const wxPoint& pos = wxDefaultPosition, const wxSize& size = wxSize(660, 640), long style = wxDEFAULT_FRAME_STYLE | wxRESIZE_BORDER | wxTAB_TRAVERSAL);
    ~EditProductDialogBase();
protected:
...
#endif //BITCOIN_EDITPRODUCTDIALOGBASE_H
