#include "ViewProductDialogBase.h"

ViewProductDialogBase::ViewProductDialogBase(wxWindow* parent, wxWindowID id, const wxString& title, const wxPoint& pos, const wxSize& size, long style) : wxFrame(parent, id, title, pos, size, style)
{
    ...
    // Connect Events
    m_buttonSubmitForm->Connect(wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler(ViewProductDialogBase::OnButtonSubmitForm), nullptr, this);
    m_buttonCancelForm->Connect(wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler(ViewProductDialogBase::OnButtonCancelForm), nullptr, this);
    m_buttonBack->Connect(wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler(ViewProductDialogBase::OnButtonBack), nullptr, this);
    m_buttonNext->Connect(wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler(ViewProductDialogBase::OnButtonNext), nullptr, this);
    m_buttonCancel->Connect(wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler(ViewProductDialogBase::OnButtonCancel), nullptr, this);
}

ViewProductDialogBase::~ViewProductDialogBase()
{
    // Disconnect Events
    m_buttonSubmitForm->Disconnect(wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler(ViewProductDialogBase::OnButtonSubmitForm), nullptr, this);
    m_buttonCancelForm->Disconnect(wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler(ViewProductDialogBase::OnButtonCancelForm), nullptr, this);
    m_buttonBack->Disconnect(wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler(ViewProductDialogBase::OnButtonBack), nullptr, this);
    m_buttonNext->Disconnect(wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler(ViewProductDialogBase::OnButtonNext), nullptr, this);
    m_buttonCancel->Disconnect(wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler(ViewProductDialogBase::OnButtonCancel), nullptr, this);
}